...
function Navbar(props) {
  ...
  const [
    ...
    setHandleLogInEmailChange,
    resetHandleLogInEmailChange,
  ] = useInput("");
  const [
    handleLogInPassChange,
    setHandleLogInPassChange,
  ...
  // Sign Up inputs
  const [
    handleSignUpUserChange,
    setHandleSignUpUserChange,
    resetHandleSignUpUserChange,
  ] = useInput("");
  const [
    handleSignUpEmailChange,
    setHandleSignUpEmailChange,
    resetHandleSignUpEmailChange,
  ] = useInput("");
  const [
    handleSignUpPassChange,
    setHandleSignUpPassChange,
          ...
          <div className={classes.paper}>
            <form onSubmit={handleLogInSubmit} className="userAuth">
              ...
              <TextField
                type="email"
                required
                value={handleLogInEmailChange}
                onChange={setHandleLogInEmailChange}
              ...
              <TextField
                type="password"
                required
                value={handleLogInPassChange}
                onChange={setHandleLogInPassChange}
          ...
          <div className={classes.paper}>
            <form onSubmit={handleSignUpSubmit} className="userAuth">
              ...
              <TextField
                type="text"
                required
                value={handleSignUpUserChange}
                onChange={setHandleSignUpUserChange}
                style={{ marginTop: "15px", marginBottom: "10px" }}
                label="UserName"
              />
              <TextField
                type="email"
                required
                value={handleSignUpEmailChange}
                onChange={setHandleSignUpEmailChange}
              ...
              <TextField
                type="password"
                required
                value={handleSignUpPassChange}
                onChange={setHandleSignUpPassChange}
                style={{ marginTop: "5px", marginBottom: "25px" }}
                label="Password"
              />
              <button
  ...
  const whenLoggedIn = (
    ...
    <MenuItem ><a style={{color: "black"}} href="/profile/saved"><BookmarksIcon/> Saved</a></MenuItem> */}
      <MenuItem onClick={handlePostAdding}>
        <AddBoxIcon /> Create Post
      </MenuItem>
      {/********************************* Post Adding Modal ****************************************************/}
